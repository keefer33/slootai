...
const createAppTheme = (primaryColor: string = 'cyan') =>
  createTheme({
    scale: 1.1,
    fontSmoothing: true,
    focusRing: 'auto',
...
export const createThemeWithColor = (primaryColor: string) => mergeMantineTheme(DEFAULT_THEME, createAppTheme(primaryColor))
